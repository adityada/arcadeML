...
function setup() {
  ...
  let playerBirdSprite = loadImage('../../images/eaglePlayer.png');
  let oppBirdSprite = loadImage('../../images/eagleGreen.png');
  bird = new Bird(birdBrain, oppBirdSprite);
  playerBird = new PlayerBird(playerBirdSprite);
