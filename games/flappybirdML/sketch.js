...
function draw() {
  ...
  for(let pipe of pipes) {
    ...
    text('pipe-xPos', textOffsetX, height/8.5)
    text('velocity', textOffsetX, height/6.3)
    ...
    text((bird.inputs[3] * width).toFixed(0), inputTextOffsetX, height/8.5)
    text((bird.inputs[4]).toFixed(0), inputTextOffsetX, height/6.3)
